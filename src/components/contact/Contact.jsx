...
const Contact = () => {
  ...
  const sendEmail = (e) => {
    ...
    emailjs.sendForm('service_yu73dop', 'template_vwfmast', form.current, 'SEwJUV8u6lmhBQFch')
      .then((result) => {
       ...
       <div className="container contact__container">
        <div className="contact__options">
          ...
          <article className="contact__option">
            ...
            <h4>Messenger</h4>
            <h5>Joachim DEGBOE</h5>
            <a href="https://m.me/100011019161318" target="_blank">Envoyer un message</a>
          </article>
          <article className="contact__option">
